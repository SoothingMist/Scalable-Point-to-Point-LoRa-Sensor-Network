...
// Basic LoRa Sender Node. Illustrates soil-moisture sensors.
...
void setup()
{
  ...
  // Ready
  Serial.println("===============================================");
  Serial.println("Arduino MKR 1310 basic LoRa sender test for VWC");
  Serial.println("===============================================");
}
...
void loop()
{
  ...
  char message[100];
  sprintf(message, "Volts:%5.1f:VWC:%5.1f", volts, VWC);
...
// Takes voltage as input, locates it in the table, applies the equation of a line, and delivers the result. In this case, the result is VWC.
