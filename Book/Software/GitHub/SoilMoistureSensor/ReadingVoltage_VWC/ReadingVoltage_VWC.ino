...
void loop()
{
  ...
  Serial.print("Y-Axis-Min=-1,");
  Serial.print("Sensor_Volts=" + String(volts));
  Serial.print(",VWC=" + String(VWC));
  Serial.println(",Y-Axis=Max=60");
  
  if(volts != (float)NULL)
    Serial.print(-1.0f, 1);   Serial.print(","); Serial.print(volts, 1); Serial.print(",");
    Serial.print(VWC, 1); Serial.print(","); Serial.println(60.0f, 1);
