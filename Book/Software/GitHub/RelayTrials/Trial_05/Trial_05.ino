/*
   ...
   Description: Demonstration of two relay pairs.
                One pair or the other is triggered.
                These are wired as in the documentation
...
#define RelayControl_1_1 4
#define RelayControl_1_2 5
#define RelayControl_2_1 2
#define RelayControl_2_2 3
