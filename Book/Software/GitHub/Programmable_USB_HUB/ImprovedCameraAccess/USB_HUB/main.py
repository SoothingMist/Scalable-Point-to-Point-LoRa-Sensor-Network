...
if __name__ == '__main__':
  ...
  while True:
    ...
    if PORT_A.in_waiting > 0:
      ...
      # For this demonstration, we assume byte messages.
      # Each cell of the message has a value 0 .. 255.
      # Only the message total length is reported for this case.
    ...
    if PORT_B.in_waiting > 0:
      ...
      # Each cell of the message has a value 0 .. 255.
      # Only the message total length is reported for this case.
      print("{:.2f}".format(time.time()), " > PORT_B message length: ",
            int.from_bytes(MESSAGE[0], sys.byteorder))
