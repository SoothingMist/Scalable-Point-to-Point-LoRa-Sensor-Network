...
void AES::CheckLength(unsigned int len) {
  ...
  {
    Serial.print("Plaintext length must be divisible by "); Serial.println(blockBytesLen);
    // exit(1); // bigger issue here as the length can become corrupted, more repair needed
  }
}
