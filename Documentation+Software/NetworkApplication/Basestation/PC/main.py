...
root.geometry("900x625+0+0") # https://www.tutorialspoint.com/how-to-specify-where-a-tkinter-window-should-open#:~:text=Tkinter%20window%20can%20be%20configured,open%20in%20a%20particular%20position.
...
graphMessage.place(relx = 0.33, rely = 0.87)
graphSensors = []
graphDropdown = ttk.Combobox(state="readonly", values=graphSensors, width=25)
graphDropdown.place(relx = 0.12, rely = 0.87)

# Add a general information display
maxGeneralInformationPostings = 30
...
start_button.place(relx = 0.005, rely = 0.88)

# Add the Stop-Button
stop_button =\
  tkinter.Button(root, text='Click to Stop', bd='5',
                 command=Stop_Button_functionality)
stop_button.place(relx = 0.005, rely = 0.94)
